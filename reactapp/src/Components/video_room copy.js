...
class VideoRoom extends Component {
  ...
  handleTrackEvent = (e) => {
    ...
    this.rVideo.current.srcObject = e.streams[0];
  }
      ...
      return (
        <div>
          ...
          <div>
            ...
            <video className='video_element' width="320" height="240" autoPlay loop={true} ref={this.lVideo}></video>
            <video className='video_element' width="320" height="240" autoPlay loop={true} ref={this.rVideo}></video>
          </div>
        </div>
      );
