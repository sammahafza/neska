...
class Testing extends Component {
    ...
    componentDidMount = () => {
        ...
        const first = this.props.match.params.first;
        const last = this.props.match.params.last;
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    {/*<video className='remote_video' autoPlay width="320" height="240" loop={true} ref={lVideo}></video>
                    <video className='remote_video' autoPlay width="320" height="240" loop={true} ref={rVideo}></video>*/}
                </div>
            </div>
        );
